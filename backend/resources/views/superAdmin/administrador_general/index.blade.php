...
@section('contenidoPrincipal')
    <div class="container">
        ...
        <a class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#createMainAdmin" role="button">Agregar
            administrador</a>
    ...
    @include('superAdmin/administrador_general/modal')
@endsection
...
@section('js')
    ...
    <script src="{{ asset('assets/js/superAdmin/administrador/service.js') }}"></script>
