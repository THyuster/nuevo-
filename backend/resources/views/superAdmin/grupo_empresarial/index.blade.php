...
@section('contenidoPrincipal')
    <div class="container">
        ...
        <h4 class="toUpperCase">Grupos empresariales/Clientes</h4>
        {{-- boton de creación abre modal --}}
        <a class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#createClient" role="button">Agregar grupo
            empresarial/cliente</a>
        <div class="container">
    ...
    @include('superAdmin/grupo_empresarial/modal')
@endsection
@section('js')
    ...
    <script src="{{ asset('assets/js/superAdmin/grupoEmpresarial/service.js') }}"></script>
    ...
    <script>
        $(document).ready(async function() {
            ...
            await cargarDatos(`${URL_PETICION_MODULOS}/show`, buttonsModal, "#compactData", camposExcluir,
                orden);
