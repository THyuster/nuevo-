<x-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Una vez que tu cuenta sea eliminada, todos los recursos y la información será eliminada permanentemente. Antes de eliminar tu cuenta, por favor verifique la información que desee guardar.') }}
        </div>
