{{--modal de elminación--}}
<div id="deleteGroupArticles" class="modal fade" tabindex="-1" aria-labelledby="createMenuLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id="btnDeleteGroupArticles" class="btn btn-primary" tabindex="4">Borrar</button>
...
{{--modal de creación--}}
<div class="modal fade " id="createArticleGroup" tabindex="-1" aria-labelledby="creategroupArticlesLabel"
    aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-sm ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createModulesLabel">Crear Nuevo grupo de artículos</h5>
            ...
            <div class="modal-footer">
                <button id="btnCreateGroupArticles" class="btn btn-success" type="submit"
...
{{--modal de edición--}}
<div class="modal fade " id="editGroupArticles" tabindex="-1" aria-labelledby="editGroupArticlesLabel"
    aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-sm ">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <button id="btnEditGroupArticles" class="btn btn-success" tabindex="4">Confirmar</button>
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" class="btn btn-secondary"
                    tabindex="5">Cancelar</button>
            </div>
