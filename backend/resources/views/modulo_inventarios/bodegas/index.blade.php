...
<div class="container">
    <h4 class="mt-2">ASIGNACION DE BODEGAS :</h4>
    ...
    <div class="container">
        <a href="#Crear" class="btn btn-primary mb-3 create_menu" data-bs-toggle="modal" data-bs-target="#createStore"
            role="button">Crear bodega</a>
        {{--Datatable de menus--}}
...
@include('modulo_inventarios/bodegas/modals')
@endsection
@section('js')
...
<script src="{{asset('assets/js/modulo_inventarios/bodegas/Service.js')}}"></script>
