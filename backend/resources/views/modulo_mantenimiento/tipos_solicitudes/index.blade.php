...
<div class="container">
    ...
    <div class="container pt-3 pb-3">
        ...
        <a class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#createTypeRequest" role="button">Crear nuevo tipo de solicitud</a>
        <table id="compactData" ></table>
    </div>
</div>
{{-- class="dt-head-center shadow border table-responsive table table-hover table-striped" --}}
@include('modulo_mantenimiento/tipos_solicitudes/modals')
@endsection
...
<script src="{{ asset('assets/js/modulo_mantenimiento/tipos_solicitudes/service.js') }}"></script>
