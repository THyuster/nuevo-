<?php
namespace App\Utils\Constantes\ModuloInventario\Talla;
...
class CTalla {
    ...
    {
        return "SELECT * FROM inventarios_talla WHERE codigo = '$codigo'";
    }

    public function sqlSelectAll(): string
    {
        return  "SELECT * FROM inventarios_talla";
    }
    public function sqlSelectById($id): string
    {
        return "SELECT * FROM inventarios_talla WHERE id = '$id'";
    }
    ...
    public function sqlInsert($entidadTiposSolicitudes): string
    {
        ...
        return "INSERT INTO inventarios_talla ($consultaCampos) VALUES ($consultaValues)";
    }
    ...
    public function sqlUpdate($id, $entidadTiposSolicitudes): string
    {
        ...
        return "UPDATE inventarios_talla SET $consultaSet WHERE `id` = '$id'";
    }

    public function sqlDelete($id): string
    {
        return "DELETE FROM inventarios_talla WHERE `id` = '$id'";
    }

    public function sqlUpdateEstado($id, $estado)
    {
        return "UPDATE inventarios_talla
        SET `estado`='$estado'
        WHERE `id` = '$id'";
    }
