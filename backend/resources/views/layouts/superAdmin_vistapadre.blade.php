                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul id="MainMenu" class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                echo '<li><a class="dropdown-item" href="/' . $key['ruta'] . '">' . $key['descripcion'] .
                                        '</a></li>';
                                }
                                @endphp
                            </ul>
                        ...
                        @if ($modulo->nombre_modulo === "Super Admin")
                        @if (count($modulo->menu) > 0)
                        @foreach ($modulo->menu as $item)
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown{{ $item->menus }}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                {{ $item->menus }}
                            </a>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown{{ $item->menus }}">
                                ...
                                <li class="position-relative">
                                    <a class="dropdown-item dropdown-toggle" href="#">{{ $submenu->descripcion_submenu
                                        }}</a>
