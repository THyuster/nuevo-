...
<div class="container">
    ...
    <h3>Gestión de tipos de Comprobantes</h3>
    ...
    <div class="container">
        <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#createTypeReceipt" role="button">Crear nuevo tipo de comprobante</button>
        {{--Espacio para DataTable--}}
        <table id="compactData"></table>
    </div>
</div>

@include('modulo_contabilidad/tipos_comprobantes/modal')
...
<script src="{{ asset('assets/js/modulo_contabilidad/receiptsTypes/service.js') }}"></script>
