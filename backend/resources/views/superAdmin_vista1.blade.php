...
<div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-6">
                ...
                <div class="ml-12">
                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                        <h3><strong>SUPER ADMIN</strong></h3> </br>
                        Bienvenido </br>
                    </div>
                </div>
            </div>
    ...
    <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
        <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
            Sistema Version {{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }}) Ing. Marvin J.
            Martinez A. - Whatsapp 322 714 5421 <b style="opacity: 0.25"> y sus secuaces </b>
        </div>
    </div>
</div>
@endsection