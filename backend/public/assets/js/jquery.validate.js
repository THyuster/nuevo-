		...
		validate: function (options) {
			...
			if (!this.length) {
				if (options && options.debug && window.console) {
					console.warn("No ha seleccionado nada, no se puede validad, no se retorna nada.");
				}
				return;
			}
				...
				for (method in rules) {
					...
					try {
						...
						if (this.settings.debug && window.console) {
							console.log("Ocurrió una excepción verificando el elemento " + element.id + ", verifique el '" + rule.method + "' metodo.", e);
						}
						if (e instanceof TypeError) {
							e.message += ".  Ocurrió una excepción verificando el elemento" + element.id + ", verifique el '" + rule.method + "' metodo.";
						}
		...
		methods: {
			...
			step: function (value, element, param) {
				var type = $(element).attr("type"),
					errorMessage = "Tipo de atributo o tipo de input " + type + " no es soportado.",
