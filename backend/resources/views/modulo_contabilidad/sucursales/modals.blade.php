            ...
            <div class="container">
                <div class="modal-body form-group">
                    <form id="formPermisosCrear">
                        ...
                        <div class="form-group">
                            <label for="empresa" class="form-label">Razon social:</label>
                            <select id="empresa_id" name="razon_social" class="form-select" required>
                                @foreach ($companies as $companie)
                                <option value="{{ $companie->id}}">{{$companie->razon_social}}</option>
                                @endforeach
                            </select>
                        </div>
                    </form>
        ...
        <div class="modal-dialog  modal-dialog-centered modal-sm ">
            <div class="modal-content">
                ...
                <div class="modal-body form-group">
                    ...
                    <select id="idSucursalUpdate" name="sucursal" class="form-select" required>
                        ...
                        @endforeach
                            ...
                            <label for="empresa" class="form-label">Razon social:</label>
                            <select id="empresaIdUpdate" name="razon_social" class="form-select" required>
